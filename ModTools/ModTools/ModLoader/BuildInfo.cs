...
public static class BuildInfo
{
	...
	public static readonly string BuildIdentifier = Assembly.ReflectionOnlyLoad(Path.Combine()).GetCustomAttribute<AssemblyInformationalVersionAttribute>().InformationalVersion;
